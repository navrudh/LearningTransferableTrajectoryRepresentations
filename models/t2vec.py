"""
Paper: Deep Representation Learning for Trajectory Similarity Computation

Reference: DOI: 10.1109/ICDE.2018.00062

File Source: https://github.com/boathit/t2vec
"""
...
class EncoderDecoder(nn.Module):
    def __init__(self, vocab_size, embedding_size, hidden_size, num_layers, dropout, bidirectional):
        ...
        self.encoder = Encoder(embedding_size, hidden_size, num_layers, dropout, bidirectional, self.embedding)
        self.decoder = Decoder(embedding_size, hidden_size, num_layers, dropout, self.embedding)
        self.num_layers = num_layers
